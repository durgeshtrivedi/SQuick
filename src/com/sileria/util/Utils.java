...
public class Utils {
	...
	/**
	 * Returns the default value if string is null or empty.
	 */
	...
	/**
	 * {@linkplain URLEncoder#encode(String, String)}
	 * int silently with default value. Returns the same
	 * unchanged value on error.
	 */
	public static String urlEncode (String value) {
		...
		try {
			...
			Log.w( "URL encode failed for: " + value, e );
			return value;
		}
	}
